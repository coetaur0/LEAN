"""
Train the LEAN model on the preprocessed SNLI dataset.
"""
# Aurelien Coet, 2019.
...
def main(train_file,
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        if epoch_accuracy < best_score:
            ...
            # training from the best model, use the 'lean_*.pth.tar'
            # checkpoints instead.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train the LEAN model on SNLI")
