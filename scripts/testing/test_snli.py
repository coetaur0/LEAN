"""
Test the LEAN model on some preprocessed dataset.
"""
# Aurelien Coet, 2019.
...
from lean.utils import correct_predictions
...
def main(test_file, pretrained_file, batch_size=32):
    ...
    hidden_size = checkpoint["model"]['_encoding._encoder.weight_ih_l0'].size(1)
    ...
    print(20 * "=",
          " Testing LEAN model on device: {} ".format(device),
          20 * "=")
